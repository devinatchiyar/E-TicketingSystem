...
public class viewtravel extends HttpServlet{
    Connection c=null;
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rs = s.executeQuery("select * from travels"); 
...
out.println("<td>SEAT</td></tr>"); 
while(rs.next()) 
{
out.println("<tr><td>'"+rs.getString("travellername")+"'</td>"); 
...
out.println("<td>'"+rs.getString("seat")+"'</td></tr>"); 
} 
