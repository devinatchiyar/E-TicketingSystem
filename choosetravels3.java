...
public class choosetravels3 extends HttpServlet{
    Connection c=null;
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rs=s.executeQuery("select tickets from bus3 where busname='"+travels+"'");
        rs.beforeFirst();
        while(rs.next()){
